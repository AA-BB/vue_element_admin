        ...
        <!-- <el-col :span="24" style="padding-bottom: 0px;">
         ...
         <el-col :span="24" style="padding-bottom: 0px">
            <el-form :inline="true" label-width="80px" >
                ...
                <el-button type="primary" plain @click="unPass()">不通过</el-button>
            </el-form>
        </el-col>
        <!--提交审核-->
      <el-dialog
        title="提交审核"
        :visible.sync="passArticle"
        width="30%"
        center>
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="passArticle = false">取 消</el-button>
          <el-button type="primary" @click="okPass()">確定</el-button>
        </span>
      </el-dialog>
      <el-dialog
        title="提交审核"
        :visible.sync="unpassArticle"
        width="30%"
        center>
        <el-form :inline="true" :model="list" label-width="80px" >
                   确认不通过该文章审核？
        ...
        <span slot="footer" class="dialog-footer">
          <el-button @click="unpassArticle = false">取 消</el-button>
          <el-button type="primary" @click="noPass()">確定</el-button>
        </span>
      </el-dialog>
     </div>
...
return(this.file_id);
        ...
        pass(){
            this.passArticle=true;
        },
        unPass(){
            this.unpassArticle=true;
        },
        okPass(){
            var param={
                id:this.id,
                "pass":true//是否通过。True:通过，false:拒绝
            }
             sysApi.shenhe(param)
                .then(data => {
        ...
        noPass(){
            var param={
                id:this.id,
                "pass":false//是否通过。True:通过，false:拒绝
            }
             sysApi.shenhe(param)
                .then(data => {
                    if(data.success==true){
