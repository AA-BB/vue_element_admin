      ...
      <el-dialog
        ...
        <el-form label-width="80px" label-position="left" :model="changeform" class="editform1">
          ...
          <el-form-item label="上传文件">
            <el-upload action="http://api.admin.js.ispeed.cn/api/v1/version/upload" :limit=1  :before-upload="newFile" :http-request="upload" v-model="changeform.file_name">
      ...
      <el-dialog
        ...
        <el-form label-width="120px" label-position="left" :model="addEdition">
          ...
          <el-form-item label="备注">
           ...
           <el-form-item label="上传文件">
            <el-upload action="http://api.admin.js.ispeed.cn/api/v1/version/upload" :limit=1  :before-upload="newFile" :http-request="upload" v-model="addEdition.file_name">
                    <el-button type="primary" size="small">点击上传</el-button>
             </el-upload>
          </el-form-item>
        </el-form>
